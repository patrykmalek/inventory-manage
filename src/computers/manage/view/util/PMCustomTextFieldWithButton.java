...
public class PMCustomTextFieldWithButton<T> extends JPanel {
	...
	private ImageIcon buttonIconActive;
	...
	public PMCustomTextFieldWithButton(boolean editable) {
	...
	private void createVisuals() {
		setButtonIcon(createButtonIcon());
		setButtonIconActive(createButtonIconActive());
	...
	private ImageIcon createButtonIconActive() {
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				if(getButton().isEnabled()) {
					button.setIcon(getButtonIconActive());
				}
			}
	...
	public void setFieldsEditable() {
		getCustomTextField().setEditable(false);
	...
	public ImageIcon getButtonIconActive() {
		return buttonIconActive;
	}


	public void setButtonIconActive(ImageIcon buttonIconActive) {
		this.buttonIconActive = buttonIconActive;
	}
