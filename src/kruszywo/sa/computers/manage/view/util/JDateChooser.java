...
public class JDateChooser extends JPanel implements ActionListener, 
 ...
 public JDateChooser(JCalendar jcal, Date date, String dateFormatString, 
  ...
  setDate(date); 
  //URL iconURL = JDateChooser.class.getResource("/JDateChooserIcon.gif");//getClass().getResource("/HotelManagement/src/main/java/datechooser/images/JDateChooserIcon.gif"); 
